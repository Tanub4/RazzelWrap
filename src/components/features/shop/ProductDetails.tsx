                ...
                <div className="flex flex-col md:flex-row gap-0 md:gap-8 bg-white md:rounded-3xl md:shadow-sm md:p-8 md:min-h-[600px] overflow-hidden">
                            ...
                            <div className="flex justify-center gap-2 mt-4 px-4 overflow-x-auto pb-2">
                                {product.images.map((img, idx) => (
                                    <button
                                        ...
                                        className={`relative w-16 h-16 border-2 rounded-lg overflow-hidden flex-shrink-0 transition-all ${currentSlide === idx ? 'border-pink-400' : 'border-transparent opacity-70 hover:opacity-100'
                                            }`}
                                    >
                                        <Image
                                            src={img}
                    ...
                    <div className="flex-1 px-4 py-6 md:py-4 md:px-0">
                        ...
                        <div className="flex items-center gap-2 mb-3">
                            ...
                            <div className="flex items-center text-pink-500 text-[10px] font-bold">
                ...
                <div className="mt-12 mb-24 md:mb-12">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                        {localProducts
                            ...
                            .slice(0, 4)
                            .map(related => (
                                <Link key={related.id} href={`/shop/${related.id}`} className="group bg-white p-4 rounded-2xl shadow-sm border border-transparent hover:border-pink-400 transition-all">
