            ...
            <div className="relative aspect-square bg-[#F5F5F5] rounded-xl overflow-hidden shrink-0">
                ...
                {quantity === 0 ? (
                    <button
                        ...
                        className="absolute bottom-2 right-2 bg-white text-black text-xs font-bold px-3 py-1 rounded-md shadow-sm border border-gray-200 hover:bg-primary hover:text-white transition-colors uppercase tracking-wide z-10"
                        suppressHydrationWarning
                    >
                        ADD
                    </button>
                ) : (
                    <div className="absolute bottom-2 right-2 flex items-center bg-primary rounded-md shadow-sm overflow-hidden z-10">
                        <button
                            onClick={(e) => {
                                e.preventDefault();
                                e.stopPropagation();
                            ...
                            className="w-7 h-6 flex items-center justify-center text-white hover:bg-black/10 transition-colors"
                        >
                            -
                        </button>
                        <span className="text-white text-xs font-bold px-1 min-w-[1.5rem] text-center">{quantity}</span>
                        <button
                            onClick={(e) => {
                                e.preventDefault();
                                e.stopPropagation();
