...
export function CartSheet() {
    ...
    // Hide cart sheet on checkout pages
            ...
            <SheetContent className="w-full sm:max-w-md flex flex-col p-0 bg-white">
                <SheetHeader className="px-6 py-4 border-b">
                    <SheetTitle className="flex items-center gap-2 text-xl font-bold">
                        ...
                        Your Cart <span className="text-primary">({totalItems} items)</span>
                    </SheetTitle>
                </SheetHeader>
                    ...
                    <>
                                        ...
                                        <div className="flex-1 flex flex-col justify-between">
                                            ...
                                            <div className="flex items-center justify-between mt-2">
                                                ...
                                                <div className="flex items-center gap-3">
                                                    <span className="font-bold text-gray-900">₹{((item.salePrice || item.price) * item.quantity).toFixed(0)}</span>
                                                    <button
                        ...
                        <div className="border-t bg-gray-50 p-6 space-y-4">
                            ...
                            <Link href="/checkout" onClick={toggleCart}>
                                <Button className="w-full h-12 bg-primary hover:bg-primary/90 text-white font-bold text-base rounded-xl transition-all shadow-md hover:shadow-lg shadow-primary/20">
                                    Proceed to Buy
                                </Button>
                            </Link>
                        </div>
